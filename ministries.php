...
<body class="bg-brand-cream text-gray-800 antialiased selection:bg-brand-gold selection:text-white">
    ...
    <!-- Header -->
    <header class="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden parallax-section" style="background-image: url('IMG_1086.jpg');">
        ...
        <div class="relative z-20 container mx-auto px-6 text-center text-white mt-12">
            <h1 class="text-4xl md:text-6xl font-serif font-bold mb-4 animate-fade-up">Serve & Grow</h1>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6 text-center max-w-3xl">
            <span class="text-brand-gold font-bold tracking-widest uppercase text-xs mb-2 block">Get Involved</span>
            <h2 class="text-3xl font-serif font-bold text-gray-900 mb-6">Every Member a Minister</h2>
            <p class="text-gray-600 leading-relaxed mb-0">
                At Mission Hope, we believe that everyone has something unique to offer. Our ministries are designed to serve our church family and reach out to our community. Whether you love teaching, singing, helping those in need, or organizing events, there is a place for you here.
            </p>
        </div>
    </section>
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-6">
                            ...
                            <div>
                                <h4 class="text-xl font-bold text-gray-900 mb-2">Pray & Reflect</h4>
                         ...
                         <div class="flex gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">Attend the next meeting or event. Don't worry about being perfect; just come with a willing heart.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2">
                    <div class="bg-gray-50 border border-gray-100 rounded-2xl p-8 shadow-sm">
                        <h3 class="text-2xl font-serif font-bold text-gray-900 mb-6 flex items-center gap-3">
                            <ion-icon name="calendar-outline" class="text-brand-gold"></ion-icon>
                            Ministry Schedule
                        </h3>
                        <div class="space-y-4">
