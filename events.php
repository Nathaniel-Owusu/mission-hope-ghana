...
<body class="bg-brand-cream text-gray-800 antialiased selection:bg-brand-gold selection:text-white">
    ...
    <header class="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden parallax-section" style="background-image: url('IMG_1086.jpg');">
        ...
        <div class="relative z-20 container mx-auto px-6 text-center text-white mt-12">
            <span class="inline-block py-1 px-4 border border-white/30 rounded-full bg-white/10 backdrop-blur-md text-xs font-bold tracking-[0.2em] uppercase mb-4 animate-fade-up">Fellowship</span>
            <h1 class="text-4xl md:text-6xl font-serif font-bold mb-4 animate-fade-up delay-100">Events Calendar</h1>
            <p class="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto font-light leading-relaxed animate-fade-up delay-200">
                Join us for worship, community service, and fellowship events.
            </p>
        </div>
    </header>
